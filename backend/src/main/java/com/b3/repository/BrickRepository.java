...
public interface BrickRepository extends JpaRepository<Brick, Long> {
     ...
     */
    List<Brick> findByBrickStatus(Brick.BrickStatus status);

    /**
     * Find user's bricks by status
     */
    List<Brick> findByUserProfileAndBrickStatus(UserProfile userProfile, Brick.BrickStatus status);
     ...
     */
    long countByUserProfileAndBrickStatusAndBrickDateBetween(
        UserProfile userProfile,
     ...
     */
    List<Brick> findByUserProfileAndBrickStatusOrderByBrickDateDesc(
        UserProfile userProfile,
        Brick.BrickStatus status
    );
